...
export default function Home() {
  ...
  return (
    <div className="h-[100dvh] max-h-[100dvh] overflow-hidden bg-[#1b262c] p-2 md:p-6 font-serif flex flex-col items-center relative">
      ...
      {/* Main Game Log */}
      <div className="w-full max-w-4xl bg-[#f4f1e1] flex-1 overflow-y-auto p-4 md:p-8 border-x border-[#90a4ae] shadow-lg flex flex-col gap-6" style={{ backgroundImage: "url('https://www.transparenttextures.com/patterns/aged-paper.png')", minHeight: "60vh" }}>
