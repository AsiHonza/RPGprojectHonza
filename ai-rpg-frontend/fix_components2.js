function scanAndFix(dir) {
    ...
    function fixTheme(filePath) {
        ...
        content = content.replace(/bg-black\/90/g, 'bg-[#e5dfc5]');
        content = content.replace(/bg-black\/80/g, 'bg-[#e5dfc5]');
        content = content.replace(/bg-black\/70/g, 'bg-white/90');
        content = content.replace(/bg-black\/60/g, 'bg-[#f9f6e6]/90');
        content = content.replace(/bg-black\/50/g, 'bg-[#f9f6e6]/80');
        content = content.replace(/bg-black\/40/g, 'bg-[#f9f6e6]/70');
        content = content.replace(/bg-black\/30/g, 'bg-[#f9f6e6]/60');
        content = content.replace(/bg-black\/20/g, 'bg-[#f9f6e6]/50');
        content = content.replace(/bg-black\/10/g, 'bg-[#f9f6e6]/40');
        content = content.replace(/bg-black/g, 'bg-[#f9f6e6]');
        ...
        content = content.replace(/text-indigo-200/g, 'text-indigo-900');
        ...
        content = content.replace(/border-gray-600/g, 'border-amber-900/20');
        ...
        // If something was already bg-white/50 and was replaced by bg-white/500... fix it
        content = content.replace(/bg-white\/500/g, 'bg-white/50');
